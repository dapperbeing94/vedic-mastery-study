#!/usr/bin/env python3
"""
Import Itihasa Translation Corpus to Supabase
Batch imports parsed Itihasa corpus entries into the pre_translated_corpus table.

Input: /home/ubuntu/vedic-mastery-study/00_DATABASE/import_data/itihasa_corpus.jsonl
Output: Supabase pre_translated_corpus table
"""
...
def import_corpus():
    """Import Itihasa corpus entries to Supabase"""
    input_file = "/home/ubuntu/vedic-mastery-study/00_DATABASE/import_data/itihasa_corpus.jsonl"
    
    print(f"📥 Importing Itihasa Translation Corpus to Supabase...")
    print(f"   Source: {input_file}")
    print(f"   Target: pre_translated_corpus table")
        ...
        for line_num, line in enumerate(f, 1):
            try:
                ...
                if len(batch) >= BATCH_SIZE:
                    ...
                    try:
                        result = supabase.table('pre_translated_corpus').insert(batch).execute()
