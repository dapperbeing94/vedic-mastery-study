#!/usr/bin/env python3
"""
Monier-Williams Dictionary Parser V3 (Final Working Version)
Correctly parses the MW dictionary with appropriate filtering.
...
class MonierWilliamsParserV3:
    ...
    def parse_entry(self, entry_lines):
        ...
        content_lines = [line for line in entry_lines[1:] if line.strip()]
        ...
        # RELAXED FILTERING: Accept any non-empty definition
        if not definition:
            return None
        ...
        return {
            'headword': headword,
            'headword_devanagari': None,  # Will be populated later if needed
    ...
    def parse_file(self):
        ...
        print(f"📖 Parsing Monier-Williams Dictionary (V3 - Final)...")
...
def main():
    ...
    parser = MonierWilliamsParserV3(input_file, output_file)
    ...
    with open(output_file, 'r', encoding='utf-8') as f:
        for i, line in enumerate(f):
            ...
            print(f"   Definition: {entry['definition'][:120]}...")
