#!/usr/bin/env python3
"""
Generate comprehensive study documents for the final 5 categories of the Vedic mastery roadmap.
"""

import json

def generate_final_docs():
    ...
    for category, content in category_content.items():
        filename = f"/home/ubuntu/vedic-mastery-study/study_documents_final/{category.lower().replace(' ', '_')}_comprehensive.md"
